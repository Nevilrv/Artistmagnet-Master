                    ...
                    Row(
                      children: [
                        Text(
                          AppString.addCredit,
                          style:
                              AppTextStyle.boldBlack16.copyWith(fontSize: 20),
                        ),
                        const Spacer(),
                        GestureDetector(
                          onTap: () {
                              ...
                              child: DropdownButton<String>(
                                ...
                                hint: Text(
                                  controller.selectedProduction.value.isEmpty
                                      ? "Select Production"
                                      : controller.selectedProduction.value,
                              ...
                              child: DropdownButton<String>(
                                ...
                                hint: Text(
                                  controller.selectedDirector.value.isEmpty
                                      ? "Select Director"
                                      : controller.selectedDirector.value,
                                  style: AppTextStyle.regularBlack12,
                                ),
                              ),
                            ),
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:
                                    AppColors.greyColor.withValues(alpha: 0.40),
                                offset: Offset(3, 3),
                                spreadRadius: 0,
                                blurRadius: 0,
                              ),
