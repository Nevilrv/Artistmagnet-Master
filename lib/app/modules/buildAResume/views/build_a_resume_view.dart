          ...
          leading: GestureDetector(
              onTap: () {
                if (controller.pageController.page == 1.0) {
                  controller.pageController.previousPage(duration: Duration(milliseconds: 800), curve: Curves.easeIn);
                } else {
                  Get.back();
                }
              },
                    ...
                    children: [
                                        ...
                                        child: controller.images.isEmpty || controller.images == []
                                            ? Stack(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                    onTap: () {
                                                      becomePowerMagnetDialog(context, h, w);
                                                    },
                                                    child: SizedBox(
                                                      height: 70,
                                                      width: 70,
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: SizedBox(
                                        height: 150,
                                        width: 150,
                                        child: Image.asset(AppAssets.videoIcon, fit: BoxFit.cover),
                                      ),
                                    ),
                                    Positioned(
                                      right: w * 0.0 - 16,
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  flex: 3,
                                                  child: Text("Production: ", style: AppTextStyle.boldBlack14),
                                                ),
                                                Expanded(
                                                  flex: 7,
                                                  child:
                                                      Text("${controller.theater?[index].production}", style: AppTextStyle.regularBlack14),
                                                ),
                                              ],
                                            ),
                                            SizedBox(height: 5),
                                            Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  flex: 3,
                                                  child: Text("Role: ", style: AppTextStyle.boldBlack14),
                                                ),
                                                Expanded(
                                                  flex: 7,
                                                  child: Text("${controller.theater?[index].role}", style: AppTextStyle.regularBlack14),
                                                ),
                                              ],
                                            ),
                                            SizedBox(height: 5),
                                            Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  flex: 3,
                                                  child: Text("Director: ", style: AppTextStyle.boldBlack14),
                                                ),
                                                Expanded(
                                                  flex: 7,
                                                  child: Text("${controller.theater?[index].director}", style: AppTextStyle.regularBlack14),
                                                ),
                                              ],
                                            ),
                                          ],
                      ...
                      Padding(
                        ...
                        child: CustomButton(
                          ...
                          title: "Next",
                          onTap: () async {
                            controller.pageController.nextPage(duration: Duration(milliseconds: 800), curve: Curves.easeIn);
                          },
                          showBoxShadow: true,
                        ),
                      ),
